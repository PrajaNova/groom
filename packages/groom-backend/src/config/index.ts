...
export const loadConfig = (): AppConfig => {
  return {
    ...
    branding: {
      name: getEnv("BRAND_NAME", "Groom"),
      logoUrl: getEnv("BRAND_LOGO_URL", ""),
      primaryColor: getEnv("BRAND_PRIMARY_COLOR", "#2C3531"),
      secondaryColor: getEnv("BRAND_SECONDARY_COLOR", "#B48B7F"),
    ...
    providers: {
      ...
      custom: {
        ...
        callbackUrl: getEnv(
          ...
          "http://localhost:3001/api/auth/custom/callback",
        ),
        scopes: parseScopes(
