...
import { blogsContent } from "##/content/blogs/blogs";
    ...
    <main className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
      <ScrollAnimation>
        <header className="text-center mb-16">
          <h2 className="text-5xl font-extrabold text-[#2C3531] mb-4">
            {blogsContent.header.title}
          </h2>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            {blogsContent.header.subtitle}
          </p>
        </header>
      </ScrollAnimation>
      ...
      <ScrollAnimation delay={200}>
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 space-y-4 md:space-y-0">
          <input
            type="search"
            placeholder={blogsContent.filters.searchPlaceholder}
